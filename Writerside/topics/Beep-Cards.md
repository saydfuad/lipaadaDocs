...
4. Filter by **Year** At the **top right**, choose the academic year using the **Year** dropdown.
   -This helps narrow down the list by year of enrollment or current academic year.
5. Review **Beep Cards** status, Look at the **CARD NUMBER** column:
   -If it shows **“No Provided”**, it means the student doesn’t have a BeepCard yet.
...
- Go to **Beep Cards → Design Card** from the sidebar menu
- Click **Save Template** to save the design template.
